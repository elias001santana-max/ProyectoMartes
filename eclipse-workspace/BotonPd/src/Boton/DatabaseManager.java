...
public class DatabaseManager {
    ...
    public boolean agregarMantenimiento(Mantenimiento mantenimiento) {
        String sql = """
            INSERT INTO mantenimiento(numero_habitacion, fecha_limpieza) 
            VALUES(?, ?)
        """;
        ...
        try (Connection conn = DriverManager.getConnection(url);
            ...
            pstmt.setString(1, mantenimiento.getNumeroHabitacion());
            pstmt.setString(2, mantenimiento.getFechaLimpieza().toString());
    ...
    public ArrayList<Mantenimiento> obtenerTodosMantenimientos() {
        ArrayList<Mantenimiento> lista = new ArrayList<>();
        String sql = "SELECT * FROM mantenimiento ORDER BY fecha_limpieza DESC";
        ...
        try (Connection conn = DriverManager.getConnection(url);
            ...
            while (rs.next()) {
                Mantenimiento m = new Mantenimiento(
                    rs.getInt("id_limpieza"),
                    rs.getString("numero_habitacion"),
                    LocalDate.parse(rs.getString("fecha_limpieza"))
                );
                lista.add(m);
            }
        } catch (SQLException e) {
    ...
    public ArrayList<Mantenimiento> buscarMantenimientos(String query) {
        ArrayList<Mantenimiento> lista = new ArrayList<>();
        String sql = "SELECT * FROM mantenimiento WHERE numero_habitacion LIKE ? ORDER BY fecha_limpieza DESC";
    ...
    public boolean eliminarMantenimiento(int idLimpieza) {
        String sql = "DELETE FROM mantenimiento WHERE id_limpieza = ?";
    ...
    public boolean agregarPago(Pagos pago) {
        String sql = """
            INSERT INTO pagos(nombre_huesped, monto, metodo_pago, fecha_pago, numero_habitacion) 
            VALUES(?, ?, ?, ?, ?)
        """;
    ...
    public ArrayList<Pagos> obtenerTodosPagos() {
    ...
    public ArrayList<Pagos> buscarPagos(String query) {
        ArrayList<Pagos> lista = new ArrayList<>();
        String sql = "SELECT * FROM pagos WHERE nombre_huesped LIKE ? OR metodo_pago LIKE ? ORDER BY fecha_pago DESC";
    ...
    public boolean eliminarPagosPorNombreHuesped(String nombreCompleto) {
        String sql = "DELETE FROM pagos WHERE nombre_huesped = ?";
    ...
    public boolean eliminarPagosPorNumeroHabitacion(String numeroHabitacion) {
        String sql = "DELETE FROM pagos WHERE numero_habitacion = ?";
