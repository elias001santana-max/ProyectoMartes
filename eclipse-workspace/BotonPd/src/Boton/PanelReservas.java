...
public class PanelReservas extends JPanel {
    ...
    private JPanel createButtonPanel() {
        ...
        JButton btnPDF = createStyledButton("📄 PDF", new Color(220, 53, 69));
    ...
    private void exportarAPDF() {
        try {
            ...
            String desktopPath = userHome + "\\Desktop\\Reporte_Reservas_" + 
            ...
            printWriter.println("<title>Reporte de Reservas - Hotel M4</title>");
            ...
            printWriter.println("<h1>REPORTE DE RESERVAS - HOTEL M4</h1>");
            printWriter.println("<h2>Fecha: " + java.time.LocalDate.now() + "</h2>");
            printWriter.println("<table>");
            printWriter.println("<thead><tr>");
            printWriter.println("<th>ID</th><th>HUESPED</th><th>DOCUMENTO</th><th>HABITACION</th><th>ENTRADA</th><th>SALIDA</th><th>NOCHES</th><th>ESTADO</th><th>TOTAL</th>");
            printWriter.println("</tr></thead>");
            printWriter.println("<tbody>");
            
            for (Reserva r : reservas) {
                printWriter.println("<tr>");
                printWriter.println("<td>" + r.getId() + "</td>");
                printWriter.println("<td>" + r.getHuespedNombre() + "</td>");
                printWriter.println("<td>" + r.getHuespedDocumento() + "</td>");
                printWriter.println("<td>" + r.getHabitacionNumero() + "</td>");
                printWriter.println("<td>" + r.getFechaEntrada() + "</td>");
                printWriter.println("<td>" + r.getFechaSalida() + "</td>");
                printWriter.println("<td>" + r.getNochesReservadas() + "</td>");
                printWriter.println("<td>" + r.getEstado() + "</td>");
                printWriter.println("<td>$" + String.format("%.2f", r.getPrecioTotal()) + "</td>");
                printWriter.println("</tr>");
            }
            
            printWriter.println("</tbody>");
            printWriter.println("</table>");
            printWriter.println("<p class='total'>Total de reservas: " + reservas.size() + "</p>");
            printWriter.println("</body>");
            printWriter.println("</html>");
