...
echo ========================================
echo   COMPILANDO SOLO LOGIN, REGISTRO Y BARRA
echo ========================================
...
cd src
"%JAVA_BIN%\javac.exe" -encoding UTF-8 -cp ".;BD\sqlite-jdbc-3.51.1.0 (1).jar" -d ..\bin BD\Usuario.java BD\INTERFAZ.java BD\Loginn.java BD\Registro.java BD\Barraa.java
